...
public class Constants {
    public static final String REST_MULTIDIALOGO_STAGE_HOST = "https://rest-stage.multidialogo.it/api/v0.0.1";
    ...
    public static final String X_API_CLIENT_VERSION = "0.0.1";

    public static final String EMPTY_JSON = "{ \"data\": {} }";
}
